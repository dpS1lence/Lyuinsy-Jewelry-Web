...
export default function Layout() {
  ...
  return (
    <div className="flex flex-col max-w-full min-h-screen">
      {" "}
      {/* Changed max-w-dvh to max-w-full */}
      <HolidayPopup
        isOpen={isPopupOpen}
      ...
      <header className="bg-background/50 hover:bg-background/70 transition-colors border-dashed border-spacing-8 border-b-4 border-gray-100 hidden md:flex flex-col">
        ...
        <div className="bg-discount text-white text-center py-2 px-4">
          <p className="text-sm font-medium animate-pulse">
            Специални предложения! | Промокод PROMO2026
          </p>
        </div>
        ...
        <div className="relative">
          <div className="container mx-auto md:px-4 pb-4 relative z-10">
            <nav className="flex flex-col md:flex-row md:items-center justify-center md:space-x-12 pb-5">
              <Link
                to="/home"
                className="cursor-pointer text-text hover:text-hover transition-colors font-medium pl-5 mb-5 md:mb-0 md:pl-0"
              >
                Начало
              </Link>
              <Link
              ...
              <Link
                to="/collection/all"
                className="px-8 py-2 ml-5 hidden md:flex md:ml-0 font-medium w-fit cursor-pointer lg:w-auto bg-pink-100 shadow-sm rounded-md text-black"
              >
                Купи сега
              </Link>
            </nav>
      ...
      <header
        className={`bg-white w-screen top-0 border-dashed border-b-4 border-gray-100 md:hidden`}
      >
        <div className="bg-discount text-white text-center py-2 px-4">
          <p className="text-sm font-medium animate-pulse">
            Промокод за 10% отстъпка! - PROMO2026
          </p>
        </div>
      ...
      <section className="bg-blue-300 py-20 relative overflow-hidden italic text-black">
        ...
        <div className="container mx-auto px-4 text-center relative">
          <h2 className="text-5xl font-serif mb-6">
            Присъедини се към нашия VIP списък
          </h2>
      ...
      <footer className="bg-black text-white">
        <div className="container mx-auto px-4 py-12">
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8">
            <div></div>
            <div>
              <h3 className="text-xl font-serif mb-4 text-white font-bold">
                Lusy Jewelry
              </h3>
              <p className="text-white">Всички права запазени 2025©</p>
            </div>
            <div>
              <h4 className="text-lg mb-4 text-white font-bold">
                Бързи линкове
              </h4>
              <ul className="space-y-2 text-white">
                ...
                <li>
                  <Link to="/terms" className="hover:text-hover cursor-pointer">
          ...
          <p className="text-center text-white mt-10 italic text-sm">
            Този магазин и предоставените изображения са създадени от{" "}
            <a href="https://devids.eu/" className="font-bold">
              devids.eu
            </a>
            .
          </p>
