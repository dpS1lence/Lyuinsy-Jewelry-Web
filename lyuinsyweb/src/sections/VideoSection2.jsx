  ...
  return (
    <div className="bg-white flex flex-col lg:flex-row items-stretch">
      ...
      <div className="lg:w-1/2 lg:pl-32 p-4 flex flex-col justify-center items-start">
        <h2 className="text-3xl font-serif mb-2">Нова Колекция</h2>
        <p className="text-lg text-text leading-relaxed">
          Открийте нашата нова колекция от елегантни бижута.
        </p>
        <button
          onClick={learnmore}
          className="bg-black border border-black text-white px-4 py-2 mt-16 transition-colors hover:bg-white hover:text-black"
        >
          Научете повече
        </button>
      </div>
