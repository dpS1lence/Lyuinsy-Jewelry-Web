        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {items.map((item, index) => {
            return (
              <div
                key={item.$id}
                className={`group bg-background overflow-hidden transition duration-300 ${
                  item.quantity === 0 ? "cursor-not-allowed" : "cursor-pointer"
                }`}
              >
                ...
                <div
                  className={`p-6 flex flex-col justify-items-center items-center text-center ${
                    item.quantity === 0 ? "bg-accentbackground opacity-50" : ""
                  }`}
                >
