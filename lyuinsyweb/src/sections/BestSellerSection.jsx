      ...
      <div className="text-left relative bg-gradient-to-r from-accentbackground to-accentbackground-light py-20">
        <div className="mx-auto px-4 container">
          ...
          <p className="text-text text-xl">
            Открийте нашата изключителна колекция, която ще ви помогне да
            създадете незабравими моменти и да изразите своята любов по уникален
            начин.
          </p>
        </div>
      </div>
                    ...
                    <div className="relative">
                      <OptimizedImage
                        ...
                        className={`w-full lg:h-[600px] object-cover ${
                          item.quantity === 0 ? "filter grayscale" : ""
                        }`}
                      />
                      {item.quantity === 0 && (
                  ...
                  <div className="flex flex-col justify-between">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex justify-center items-center text-center">
                        <Link
                          to={`/item/${item.slug}`}
                          className={`bg-black text-white border border-black px-8 py-4 font-medium w-full lg:w-auto hover:bg-white hover:text-black transition ${
                            item.quantity === 0
