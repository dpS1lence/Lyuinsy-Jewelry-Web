import video1 from "../../src/assets/videos/videobigwoman.mp4";
...
export default function VideoSection() {
    ...
    return (
        <div className="relative w-full h-[650px] overflow-hidden">
            ...
            <div className="flex flex-col justify-center items-start mx-auto container lg:items-start absolute inset-0 p-4 text-white">
