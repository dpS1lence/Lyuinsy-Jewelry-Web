  ...
  return (
    <div className="flex flex-col items-center bg-background p-4 md:p-8">
      <div className="md:w-3/4 text-text">
        ...
        <p className="mb-1">При поръчки над 100.00лв, цената за доставка (независимо дали до личен адрес или до офис на Еконт/Спиди) ще бъде БЕЗПЛАТНА!</p>
        <p className="mb-4">За поръчки под 100.00лв. цената за доставка е 4,99лв. до офис на Еконт или Спиди.</p>
        ...
        <p className="mb-4 italic font-light">"МАРСИ ЕООД" има правото да променя тези условия по всяко време.</p>
      </div>
    </div>
  );
};
