  ...
  return (
    <div className="flex flex-col items-center bg-background p-4 md:p-8">
      <div className="md:w-3/4 text-text">
        ...
        <p className="mb-1">При поръчки над 100.00лв, цената за доставка (независимо дали до личен адрес или до офис на Еконт/Спиди) ще бъде приспадната от цената на поръчката като отстъпка, но документално, отново вие ще я платите.</p>
        <p className="mb-4 italic font-light">Пример: поръчка на стойност 125.99лв - следва да бъде начислена безплатна доставка - поръчката става 120.00лв (125.99лв - 5.99лв), а доставката 5.99лв = 125.99лв.</p>
